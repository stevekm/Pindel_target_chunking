...
vcf_table <- read.delim(file = vcf_tsv_file, header = TRUE, sep = '\t', colClasses = c("character"))
avinput <- read.delim(file = avinput_file, header = TRUE, sep = '\t', colClasses = c("character"))
